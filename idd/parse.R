...
idd_8.5 <- read_idd(here::here("idd/V8-5-0-Energy+.idd"))
idd_8.6 <- read_idd(here::here("idd/V8-6-0-Energy+.idd"))
idd_8.7 <- read_idd(here::here("idd/V8-7-0-Energy+.idd"))
idd_8.8 <- read_idd(here::here("idd/V8-8-0-Energy+.idd"))
idd_8.9 <- read_idd(here::here("idd/V8-9-0-Energy+.idd"))
devtools::use_data(
