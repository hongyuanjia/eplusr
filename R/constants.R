...
utils::globalVariables(c(
        "Case", "DateTime", "Day", "Hour", "J", "KeyValue", "Minute", "Month",
        "N", "Name", "V1", "all_cmt", "all_field_name_lower",
        "all_field_name_upper", "all_name_upper", "arch", "assigned_new_name",
        "auto", "autocalculatable", "autosizable", "base", "begin_environment",
        ...
        "core_file", "datetime", "datetime_delta", "datetime_shifted", "day",
        "def", "default", "default_id", "default_ipnum", "default_num",
        ...
        "field_name_lower", "file_name", "first_extensible", "found",
        "full_ipname", "full_name", "group", "group_id", "group_name", "grp",
        "has_any_na", "has_default", "has_external_list", "has_object_list",
        "has_range", "has_reference", "header", "hour", "id_list", "idx",
        "index", "info", "input", "input_index", "install_eplus_macos",
        "invalid_ext_num", "ip_unit", "ip_units", "is_all_na", "is_complete",
        "is_default", "is_extensible", "is_name", "key", "last_extensible",
        "last_index", "last_req_ext", "last_required", "leading_spaces",
        "left_fields", "level", "level_index", "level_num", "line", "loc_model",
        "loc_weather", "lower_incbounds", "macro_key", "max_suffix_num",
        "maximum", "maximum<", "memo", "min_fields", "minimum", "minimum>",
        ...
        "required", "required_field", "required_object", "res", "res_ran",
        "row_id", "same_dir", "same_name_order", "seperate", "slash_key",
        "slash_key_value", "slash_loc", "slash_supported", "slash_value",
        "slash_value_upper", "space_loc", "special_key", "special_loc",
        "special_value", "string", "time", "type", "unique_object", "unit",
        "unitsbasedonfield", "upper_incbounds", "use_input_name",
        "valid_ext_num", "value", "value_count", "value_ext_num", "value_id",
