...
path_model <- path_eplus_example("latest", "RefBldgMediumOfficeNew2004_Chicago.idf")
path_weather <- path_eplus_weather("latest", "USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.epw")
