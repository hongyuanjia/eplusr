...
path_model <- path_eplus_example(eplus_ver, "RefBldgMediumOfficeNew2004_Chicago.idf")
path_weather <- path_eplus_weather(eplus_ver, "USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.epw")
...
set_lpd <- function(idf, lpd = NA) {
    ...
    idf$set(Lights := list(watts_per_floor_area = lpd))
...
param_savings %>%
    ...
    geom_bar(position = "dodge", stat = "identity", width = 0.6, color = "black", show.legend = FALSE) +
