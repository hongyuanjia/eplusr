...
library(eplusr)
if (!is_avail_eplus("latest")) install_eplus("latest")
```
...
```{r read, out.lines = 10}
path <- path_eplus_example("latest", "5Zone_Transformer.idf")
model <- read_idf(path)
...
path_ddy <- path_eplus_weather("latest", "USA_CA_San.Francisco.Intl.AP.724940_TMY3.ddy")
