...
simulations.
Underneath, eplusr uses the EnergyPlus command line interface which was
introduced since EnergyPlus v8.3.0, which means that `$run()` only supports
models with version higher than v8.3.0.
