...
path_epw <- file.path(eplus_config("latest")$dir, "WeatherData/USA_CA_San.Francisco.Intl.AP.724940_TMY3.epw")
...
```{r}
path_model <- file.path(eplus_config("latest")$dir, "ExampleFiles/RefBldgMediumOfficeNew2004_Chicago.idf")
path_weather <- file.path(eplus_config("latest")$dir, "WeatherData/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.epw")
