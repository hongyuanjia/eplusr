...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_default.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_background1.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_background2.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_viewpoint1.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_axis.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_noaxis.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_ground.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_xray.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_zone_color.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_show_zone.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_show_surface.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("vignettes/geom-viewer_show_wall.png")
```
