...
```{r}
path_idf <- file.path(eplus_config(eplus_ver)$dir, "ExampleFiles/HospitalLowEnergy.idf")
...
```{r}
path_simple <- path_eplus_example(eplus_ver, "4ZoneWithShading_Simple_1.idf")
